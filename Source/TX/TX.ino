...
using int8_t = unsigned char; // voy a usar palabras de 1 byte  
using int16_t = int;

int16_t potValue {}; // adc 10 bit (0-1023) donde esta conectado el potenciometro (fondo escala=5v)
...
void loop() 
{
    ...
    int8_t message[4]; // array of bite_word type, size 4
